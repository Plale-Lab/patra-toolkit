...
The **Patra Model Cards Toolkit** is copyrighted by the **Indiana University Board of Trustees** and distributed under the **BSD 3-Clause License**. See the `LICENSE` file for more details.
